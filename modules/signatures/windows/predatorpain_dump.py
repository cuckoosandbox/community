...
class PredatorPainDump(Signature):
    name = "predatorpain_dump"
    description = "PredatorPain RAT has been indentified (config has been dumped)"
    severity = 5
    ...
    def on_yara(self, category, filepath, match):
        ...
        cfg["family"] = "PredatorPain RAT"
        cfg["cnc"] = cfg["Email Address"]
